...
//     // Constructing the initial search query for area
...
//     // Initial aggregation to check for area-based results
...
//     // If no results are found for the area query and area is provided, use Atlas Search as a fallback
//     if (total === 0 && area) {
//       console.log("No area matches found, falling back to Atlas Search...");
...
//             text: {
//               query: area,
//               path: ["title", "description", "contact.phone", "contact.email"], // Fields to search
//               fuzzy: { maxEdits: 2 }, // Allow some typo tolerance
//             },
//           },
//         },
//         { $match: { block: false } }, // Still exclude blocked ads
//         ...(service
      ...
      const atlasSearchQuery = [
        {
          $search: {
            ...
            text: {
              query: area,
              path: ["title", "description", "service", "contact.phone", "contact.email"],
              fuzzy: { maxEdits: 2 }, // Allow some typo tolerance
            },
          },
        },
